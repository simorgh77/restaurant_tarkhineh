                ...
                >
                    <SwiperSlide>
                        <div className="slider__image">
                            <img src="/img/branch/Slider.jpg" alt="slider" className="slider__image-item" />
                    ...
                    <SwiperSlide>
                        <div className="slider__image">
                            <img src="/img/index/slider2.jpg" alt="slider" className="slider__image-item" />
                            <div className="slider__image-content">
                                <h2 className="slider__image-title">
                    ...
                    <SwiperSlide>
                        <div className="slider__image">
                            <img src="/img/index/slider3.jpg" alt="slider" className="slider__image-item" />
                            <div className="slider__image-content">
                                <h2 className="slider__image-title">
                    ...
                    <SwiperSlide>
                        <div className="slider__image">
                            <img src="/img/index/slider4.jpg" alt="slider" className="slider__image-item" />
                            <div className="slider__image-content">
                                <h2 className="slider__image-title">
                    ...
                    <SwiperSlide>
                        <div className="slider__image">
                            <img src="/img/index/slider5.jpg" alt="slider" className="slider__image-item" />
                            <div className="slider__image-content">
                                <h2 className="slider__image-title">
                                    ارسال زیر 30 دقیقه
                                </h2>
                ...
                >
                    <SwiperSlide>
                        <div className="branches-slider">
                            <img src="/img/branch/branch-ekbatan.jpg" alt="branches" className="branches-slider__img" />
                    ...
                    <SwiperSlide>
                        <div className="branches-slider">
                            <img src="/img/branch/branch2.jpg" alt="branches" className="branches-slider__img" />
                            <div className="branches-slider__content">
                                <div className="branch-slider__wrapper">
                                    <div className="branch-slider__contact">
                                        <BiPhoneCall className='branch-slider__icon' />
                    ...
                    <SwiperSlide>
                        <div className="branches-slider">
                            <img src="/img/branch/branch3.jfif" alt="branches" className="branches-slider__img" />
                            <div className="branches-slider__content">
                                <div className="branch-slider__wrapper">
                                    <div className="branch-slider__contact">
                                        <BiPhoneCall className='branch-slider__icon' />
                    ...
                    <SwiperSlide>
                        <div className="branches-slider">
                            <img src="/img/branch/branch4.jpg" alt="branches" className="branches-slider__img" />
                            <div className="branches-slider__content">
                                <div className="branch-slider__wrapper">
                                    <div className="branch-slider__contact">
                                        <BiPhoneCall className='branch-slider__icon' />
